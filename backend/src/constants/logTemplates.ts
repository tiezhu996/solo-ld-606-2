export const LOG_TEMPLATES = {
  ...
  BerthPlan: ["BerthPlan.create", "BerthPlan.update", "BerthPlan.status", "BerthPlan.export", "BerthPlan.precheck", "BerthPlan.conflict", "BerthPlan.approve", "BerthPlan.approveRejected"],
